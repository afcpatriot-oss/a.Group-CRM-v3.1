<div class="row">
    <div class="col-lg-12">
        ...
        <ul data-modular-id="reports_tabs_menu" class="nav nav-tabs profile-tab reports-top-nav list-pages-crumbs"
            ...
            <?php echo $__env->yieldPushContent('menu_reports_topnav_1'); ?>
            ...
            <li class="nav-item dropdown <?php echo e($page['reports_tabs_productivty'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <!--[MODULES] - dynamic menu-->
                    <?php echo $__env->yieldPushContent('menu_reports_topnav_2'); ?>
                </div>
            </li>

            <!--[MODULES] - dynamic menu-->
            <?php echo $__env->yieldPushContent('menu_reports_topnav_3'); ?>
            ...
            <li class="nav-item dropdown <?php echo e($page['reports_tabs_productivty'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <!--[MODULES] - dynamic menu-->
                    <?php echo $__env->yieldPushContent('menu_reports_topnav_4'); ?>
                </div>
            </li>

            <!--[MODULES] - dynamic menu-->
            <?php echo $__env->yieldPushContent('menu_reports_topnav_5'); ?>
            ...
            <li class="nav-item dropdown <?php echo e($page['reports_tabs_productivty'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <!--[MODULES] - dynamic menu-->
                    <?php echo $__env->yieldPushContent('menu_reports_topnav_6'); ?>
                </div>
            </li>

            <!--[MODULES] - dynamic menu-->
            <?php echo $__env->yieldPushContent('menu_reports_topnav_7'); ?>
            ...
            <li class="nav-item dropdown <?php echo e($page['reports_tabs_productivty'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <a class="dropdown-item js-dynamic-url js-ajax-ux-request" data-toggle="tab"
                        ...
                        role="tab"><?php echo app('translator')->get('lang.overview'); ?></a>
                    <!--[MODULES] - dynamic menu-->
                    <?php echo $__env->yieldPushContent('menu_reports_topnav_8'); ?>
                </div>
            </li>

            <!--[MODULES] - dynamic menu-->
            <?php echo $__env->yieldPushContent('menu_reports_topnav_9'); ?>
            ...
            <li class="nav-item dropdown <?php echo e($page['reports_tabs_productivty'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <!--[MODULES] - dynamic menu-->
                    <?php echo $__env->yieldPushContent('menu_reports_topnav_10'); ?>
                </div>
            </li>

            <!--[MODULES] - dynamic menu-->
            <?php echo $__env->yieldPushContent('menu_reports_topnav_11'); ?>
            ...
            <li class="nav-item dropdown <?php echo e($page['reports_tabs_productivty'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <!--[MODULES] - dynamic menu-->
                    <?php echo $__env->yieldPushContent('menu_reports_topnav_12'); ?>
                </div>
            </li>

            <!--[MODULES] - dynamic menu-->
            <?php echo $__env->yieldPushContent('menu_reports_topnav_13'); ?>

        </ul>
        <!-- Tab panes -->
    </div>
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/reports/components/misc/topnav.blade.php ENDPATH**/ ?>