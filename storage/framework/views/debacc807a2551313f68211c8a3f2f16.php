...
<!--each card-->
<div class="kanban-card kanban-board-element show-modal-button reset-card-modal-form js-ajax-ux-request <?php echo e($task->pinned_status ?? ''); ?>"
    ...
    <!--cover image-->
    <div id="kanban-card-cover-image-<?php echo e($task->task_id); ?>"
        class="kanban-card-cover-image <?php echo e(runtimeKanbanCoverImage($task->task_cover_image)); ?>" <?php echo runtimeCoverImage($task->task_cover_image_uniqueid, $task->task_cover_image_filename); ?>>
    ...
    <div class="kanban-card-content-comntainer">
        ...
        <div class="x-meta">
            ...
            <!--pending checklist-->
            <?php if(config('system.settings_tasks_kanban_pending_checklists') == 'yes'): ?>
            <span>
                <strong><?php echo e(cleanLang(__('lang.pending_checklist'))); ?>:</strong>
                <label class="label <?php echo e($task->pending_checklists_count > 0 ? 'label-warning' : 'label-default'); ?> p-l-5 p-r-5 p-t-1 p-b-0 m-b-0 vertical-align-middl">
                    <?php echo e($task->pending_checklists_count); ?>
        ...
        <div class="x-footer row">
            <div class="col-6 x-icons">
                ...
                <span title="<?php echo e(cleanLang(__('lang.star_task'))); ?>"
                    class="x-icon vm p-t-2 data-toggle-action-tooltip opacity-4 font-14 ajax-request <?php echo e($task->is_starred ? 'hidden' : ''); ?> starred-star-button-<?php echo e($task->task_id); ?>"
                    id="starred-star-button-<?php echo e($task->task_id); ?>" data-stop-propagation="yes"
                    data-url="<?php echo e(url('/starred/togglestatus?action=star&resource_type=task&resource_id='.$task->task_id)); ?>"
                    data-loading-target="starred-star-button-<?php echo e($task->task_id); ?>" data-ajax-type="POST"
                ...
                <span title="<?php echo e(cleanLang(__('lang.unstar_task'))); ?>"
                    class="x-icon vm p-t-2 data-toggle-action-tooltip font-14 ajax-request text-warning <?php echo e(!$task->is_starred ? 'hidden' : ''); ?> starred-unstar-button-<?php echo e($task->task_id); ?>"
                    id="starred-unstar-button-<?php echo e($task->task_id); ?>" data-stop-propagation="yes"
                    data-url="<?php echo e(url('/starred/togglestatus?action=unstar&resource_type=task&resource_id='.$task->task_id)); ?>"
                    data-loading-target="starred-unstar-button-<?php echo e($task->task_id); ?>" data-ajax-type="POST"
                    data-on-start-submit-button="disable">
                    <i class="sl-icon-star"></i>
                </span>

                <!--pin-->
                <span title="<?php echo e(cleanLang(__('lang.pinning'))); ?>" data-parent="task_<?php echo e($task->task_id); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/tasks/components/kanban/card.blade.php ENDPATH**/ ?>