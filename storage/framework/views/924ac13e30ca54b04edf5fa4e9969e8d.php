    ...
    <div class="scroll-sidebar" id="main-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="main-sidenav">
            <ul id="sidebarnav" data-modular-id="main_menu_team">
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_1'); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_2'); ?>
                ...
                <li data-modular-id="main_menu_team_clients"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_3'); ?>
                    </ul>
                </li>
                <?php endif; ?>
                <!--customers-->
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_4'); ?>
                ...
                <li data-modular-id="main_menu_team_projects"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_5'); ?>
                    </ul>
                </li>
                <?php endif; ?>
               <!--projects-->
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_6'); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_7'); ?>
...
<li data-modular-id="main_menu_team_orders"
    class="sidenav-menu-item <?php echo e($page['mainmenu_orders'] ?? ''); ?> menu-tooltip menu-with-tooltip"
    title="<?php echo e(cleanLang(__('lang.orders'))); ?>">
    <a class="waves-effect waves-dark" href="/orders" aria-expanded="false" target="_self">
        <i class="sl-icon-call-in"></i>
...
<!--orders-->
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_8'); ?>
                ...
                <li data-modular-id="main_menu_team_billing"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_9'); ?>
                    </ul>
                </li>
                <?php endif; ?>
                <!--billing-->
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_10'); ?>
                ...
                <li data-modular-id="main_menu_team_proposals"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_11'); ?>
                    </ul>
                </li>
                <?php endif; ?>
                <!--proposals-->
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_12'); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_13'); ?>
                ...
                <li data-modular-id="main_menu_team_contracts"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_14'); ?>
                    </ul>
                </li>
                <?php endif; ?>
                <!--contracts-->
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_15'); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_16'); ?>
                ...
                <li data-modular-id="main_menu_team_spaces hidden"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_17'); ?>
                    </ul>
                </li>
                <?php endif; ?>
                <!--spaces-->
                ...
                <li data-modular-id="main_menu_team_support"
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_18'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_19'); ?>
                ...
                <li data-modular-id="main_menu_team_team"
                    ...
                    <ul aria-expanded="false" class="position-top collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_main_team_20'); ?>
                    </ul>
                </li>
                <?php endif; ?>
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_21'); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_main_team_22'); ?>
            </ul>
        </nav>
        <!-- End Sidebar navigation -->
    </div>
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/nav/leftmenu-team.blade.php ENDPATH**/ ?>