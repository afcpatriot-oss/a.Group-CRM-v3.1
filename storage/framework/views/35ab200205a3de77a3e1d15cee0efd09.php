...
<div class="checklist-item clearfix" id="task_checklist_container_<?php echo e($checklist->checklist_id); ?>"
    ...
    <input type="checkbox" class="filled-in chk-col-light-blue js-ajax-ux-request-default"
        ...
        data-type="form" data-form-id="task_checklist_container_<?php echo e($checklist->checklist_id); ?>"
        data-notifications="disabled" id="task_checklist_<?php echo e($checklist->checklist_id); ?>"
    ...
    <span
        class="checklist-text <?php echo e(runtimePermissions('task-edit-checklist', $checklist->permission_edit_delete_checklist)); ?>"
        data-toggle="edit" data-id="<?php echo e($checklist->checklist_id); ?>"
    ...
    <div class="checklist-comments-wrapper" id="checklist-comments-wrapper-<?php echo e($checklist->checklist_id); ?>">
        ...
        <div class="checklist-comments-textarea-wrapper hidden"
            ...
            <div class="text-right">
                ...
                <button type="button" class="btn btn-danger btn-xs x-submit-button checklist-comments-submit-button ajax-request"
                    data-url="<?php echo e(url('/tasks/'.$checklist->checklistresource_id.'/post-checklist-comment')); ?>"
        ...
        <div class="checklist-comments-list-wrapper hidden"
            ...
            <?php echo $__env->make('pages.task.components.checklist-comment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/task/components/checklist.blade.php ENDPATH**/ ?>