...
<div class="hidden" id="invoice-logic">
    ...
    <input type="number" class="decimal-field" name="bill_subtotal_before_discount" id="bill_subtotal_before_discount"
        value="<?php echo e($bill->bill_subtotal_before_discount ?? 0); ?>">
...
<!-----------------------------------------------------/#LOGIC & POST HIDDEN FIELDS----------------------------------------------------------><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/bill/components/elements/logic.blade.php ENDPATH**/ ?>