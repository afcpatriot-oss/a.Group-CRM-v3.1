...
<div class="filtered-results-warning opacity-8 p-b-5">
    <small>
        ...
        <a href="javascript:void(0);" class="js-toggle-side-panel" data-target="sidepanel-filter-clients"><?php echo app('translator')->get('lang.filtered'); ?></a>.
        <?php echo app('translator')->get('lang.you_can'); ?>
        <a href="<?php echo e(url('/clients?clear-filter=yes')); ?>"><?php echo app('translator')->get('lang.clear_the_filters'); ?></a>.
    </small>
</div>
<?php endif; ?>
    ...
    <div class="card-body">
        <div class="table-responsive list-table-wrapper">
            ...
            <table id="clients-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <?php echo $__env->yieldPushContent('table_1'); ?>
                <thead>
                    <tr>
                        ...
                        <th
                            ...
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_client_company_name"
                                ...
                                <?php echo app('translator')->get('lang.name'); ?><span class="sorting-icons"><i
                        ...
                        <th class="col_action with-table-config-icon"><a href="javascript:void(0)"><?php echo e(cleanLang(__('lang.action'))); ?></a>
                            ...
                            <!--module extension point - allows modules to inject content-->
                            <?php echo $__env->yieldPushContent('table_2'); ?>
                ...
                <!--module extension point - allows modules to inject content-->
                <?php echo $__env->yieldPushContent('table_3'); ?>
                ...
                <!--module extension point - allows modules to inject content-->
                <?php echo $__env->yieldPushContent('table_4'); ?>
                <tfoot>
                    <tr>
                        <td colspan="20">
                            <!--load more button-->
                ...
                <!--module extension point - allows modules to inject content-->
                <?php echo $__env->yieldPushContent('table_5'); ?>
            </table>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/clients/components/table/table.blade.php ENDPATH**/ ?>