...
<tr class="billing-line-item" id="lineitem_<?php echo e($lineitem->lineitem_id ?? ''); ?>" type="plain">
    ...
    <td class="form-group x-description bill_col_description">
        <?php if(config('system.settings2_invoices_show_long_description') == 'yes'): ?>
            ...
            <textarea class="form-control form-control-sm js_item_long_description m-t-5" rows="3"
                name="js_item_long_description[<?php echo e($lineitem->lineitem_id ?? ''); ?>]"><?php echo e($lineitem->lineitem_long_description ?? ''); ?></textarea>
        <?php else: ?>
    ...
    <td class="form-group x-discount bill_col_discount <?php echo e(runtimeVisibility('invoice-column-inline-discount', $bill->bill_tax_type)); ?>">
        <div class="input-group input-group-sm">
            <input class="form-control form-control-sm js_item_discount_value calculation-element"
                   type="text"
                   name="js_item_discount_value[<?php echo e($lineitem->lineitem_id ?? ''); ?>]"
                   value="<?php echo e($lineitem->lineitem_discount_value ?? '0.00'); ?>"
                   autocomplete="off">
            <div class="input-group-append">
                <select class="form-control form-control-sm js_item_discount_type calculation-element"
                        name="js_item_discount_type[<?php echo e($lineitem->lineitem_id ?? ''); ?>]">
                    <option value="none" <?php echo e(($lineitem->lineitem_discount_type ?? 'none') == 'none' ? 'selected' : ''); ?>>
                        <?php echo app('translator')->get('lang.none'); ?>
                    </option>
                    <option value="fixed" <?php echo e(($lineitem->lineitem_discount_type ?? '') == 'fixed' ? 'selected' : ''); ?>>
                        <?php echo e(config('system.settings_system_currency_symbol')); ?>

                    </option>
                    <option value="percentage" <?php echo e(($lineitem->lineitem_discount_type ?? '') == 'percentage' ? 'selected' : ''); ?>>
                        %
                    </option>
                </select>
            </div>
        ...
        <input type="hidden" class="js_item_discount_amount"
               name="js_item_discount_amount[<?php echo e($lineitem->lineitem_id ?? ''); ?>]"
               value="<?php echo e($lineitem->lineitem_discount_amount ?? '0.00'); ?>">
    </td>
    <!--inline tax-->
    <td
        ...
        <select name="js_item_tax[<?php echo e($lineitem->lineitem_id ?? ''); ?>]" <?php echo e(runtimeLineItemTaxStatus($lineitem->lineitem_tax_status ?? '')); ?>
            ...
            <option value="0|<?php echo e($taxrate->taxrate_name); ?>|zero-rated-tax-rate|<?php echo e($taxrate->taxrate_id); ?>"
                data-id="<?php echo e($taxrate->taxrate_id); ?>"
            ...
            <option
                ...
                data-id="<?php echo e($taxrate->taxrate_id); ?>"
                <?php echo e(runtimeInlineTaxPreselected($taxrate->taxrate_id ?? '', $lineitem->lineitem_id ?? '')); ?>>
                <?php echo e(runtimeDecimalFloat($taxrate->taxrate_value)); ?>% - <?php echo e($taxrate->taxrate_name); ?></option>
            <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
...
<!--/#EACH LINE ITEM--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/bill/components/elements/line-plain.blade.php ENDPATH**/ ?>