<div class="card-attachments" id="card-attachments"
    ...
    <div class="x-action">
        ...
        <a class="card_fileupload display-inline-block" id="js-card-toggle-fileupload"
            href="javascript:void(0)"><?php echo e(cleanLang(__('lang.add_attachment'))); ?></a>

        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_task_attach_files'); ?>
    </div>

    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('section_task_attachments'); ?>
...
<!--attachemnts js--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/task/components/attachments.blade.php ENDPATH**/ ?>