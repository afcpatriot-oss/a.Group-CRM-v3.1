...
<div class="row" id="js-trigger-clients-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>">
    <div class="col-lg-12">
        ...
        <?php echo $__env->yieldPushContent('form_create_1'); ?>
        ...
        <!--invoice due days-->
        <div class="form-group row">
            <label class="col-sm-12 col-lg-3 text-left control-label col-form-label"><?php echo app('translator')->get('lang.invoice_due_days'); ?>
                <span class="align-middle text-info font-16" data-toggle="tooltip" title="<?php echo app('translator')->get('lang.invoice_due_days_info'); ?>"
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="number" class="form-control form-control-sm" id="client_billing_invoice_due_days"
                    name="client_billing_invoice_due_days" value="<?php echo e($client->client_billing_invoice_due_days ?? ''); ?>"
                    min="0">
            </div>
        </div>
        <div class="line"></div>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('form_create_2'); ?>
        ...
        <div id="client_app_modules_collaped" class="hidden">
            ...
            <div id="client_app_modules_pemissions"
                ...
                <div class="highlighted-panel">
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_projects"
                                ...
                                <?php echo e(runtimePrechecked($client->client_settings_modules_projects ?? '')); ?>
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_invoices"
                                ...
                                <?php echo e(runtimePrechecked($client->client_settings_modules_invoices ?? '')); ?>
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_payments"
                                ...
                                <?php echo e(runtimePrechecked($client->client_settings_modules_payments ?? '')); ?>
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_knowledgebase"
                                ...
                                <?php echo e(runtimePrechecked($client->client_settings_modules_knowledgebase ?? '')); ?>
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_estimates"
                                ...
                                <?php echo e(runtimePrechecked($client->client_settings_modules_estimates ?? '')); ?>
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_subscriptions"
                                ...
                                <?php echo e(runtimePrechecked($client->client_settings_modules_subscriptions ?? '')); ?>
                    ...
                    <div class="form-group form-group-checkbox row">
                        ...
                        <div class="col-sm-12 col-lg-2 text-left p-t-5">
                            <input type="checkbox" id="client_settings_modules_tickets"
                                ...
                                <?php echo e(runtimePrechecked($client->client_settings_modules_tickets ?? '')); ?>
                    ...
                    <div class="alert alert-info"><?php echo app('translator')->get('lang.only_system_enabled_modules_enabled'); ?> <a
                            href="<?php echo e(url('app/settings/modules')); ?>" target="_blank">(<?php echo app('translator')->get('lang.see_settings'); ?>)</a>
                    </div>
                </div>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/clients/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>