...
<div class="checklist-item global-checklist-item clearfix d-flex align-items-start position-relative"
    id="checklist_container_<?php echo e($checklist->checklist_id); ?>" data-id="<?php echo e($checklist->checklist_id); ?>">
    ...
    <div class="checklist-checkbox-container flex-shrink-0 mr-2">
        <input type="checkbox" class="filled-in chk-col-light-blue js-ajax-ux-request-default"
            name="card_checklist[<?php echo e($checklist->checklist_id); ?>]" data-progress-bar='hidden'
            data-url="<?php echo e(urlResource('/checklists/toggle-checklist-status/'.$checklist->checklist_id)); ?>"
            data-ajax-type="post" data-type="form" data-form-id="checklist_container_<?php echo e($checklist->checklist_id); ?>"
            data-notifications="disabled" id="checklist_<?php echo e($checklist->checklist_id); ?>"
            <?php echo e(runtimeChecklistCheckbox($checklist->permission_edit_delete_checklist ?? false)); ?>

            <?php echo e(runtimePrechecked($checklist->checklist_status)); ?>>
        <label class="checklist-label" for="checklist_<?php echo e($checklist->checklist_id); ?>"></label>
    </div>

    <!--checklist text - middle section with proper padding-->
    <div class="checklist-text-container flex-grow-1 pr-3"
        data-target="edit-checklist-text-container-<?php echo e($checklist->checklist_id); ?>" data-parent="checklist_container_<?php echo e($checklist->checklist_id); ?>">
        <span
            class="checklist-text <?php echo e(runtimePermissions('checklist-edit', $checklist->permission_edit_delete_checklist ?? false)); ?>"
            id="checklist-text-<?php echo e($checklist->checklist_id); ?>" data-toggle="edit"
            data-id="<?php echo e($checklist->checklist_id); ?>"
            data-action-url="<?php echo e(urlResource('/checklists/update-checklist/'.$checklist->checklist_id)); ?>"><?php echo e($checklist->checklist_text); ?></span>
    </div>

    <!--action icons - far right side-->
    <?php if($checklist->permission_edit_delete_checklist ?? false): ?>
    <div class="checklist-actions-container flex-shrink-0 d-flex align-items-center">
        ...
        <a href="javascript:void(0)"
            ...
            data-ajax-type="DELETE" data-parent-container="checklist_container_<?php echo e($checklist->checklist_id); ?>"
            data-progress-bar="hidden"
            data-url="<?php echo e(urlResource('/checklists/delete-checklist/'.$checklist->checklist_id)); ?>"><i
                class="mdi mdi-delete text-default"></i></a>
    </div>
    <?php endif; ?>

    <!--checklist comments wrapper - full width below the main checklist item-->
    <div class="checklist-comments-wrapper w-100" id="checklist-comments-wrapper-<?php echo e($checklist->checklist_id); ?>">
        ...
        <div class="checklist-comments-textarea-wrapper hidden"
            ...
            <div class="text-right">
                ...
                <button type="button"
                    ...
                    data-url="<?php echo e(url('/checklists/post-checklist-comment')); ?>" data-type="form" data-ajax-type="post"
        ...
        <div class="checklist-comments-list-wrapper hidden"
            ...
            <?php echo $__env->make('pages.checklists.checklist-comment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div>
...
<div class="hidden edit-checklist-text-container p-l-25 p-b-30"
    id="edit-checklist-text-container-<?php echo e($checklist->checklist_id); ?>">
    <textarea class="form-control form-control-sm checklist_text" rows="3" name="checklist_text" id="update-checklist-textarea-<?php echo e($checklist->checklist_id); ?>"><?php echo e($checklist->checklist_text); ?></textarea>
    <div class="text-right">
        ...
        <button type="button" class="btn btn-default  btn-xs update-checklist-close-button" 
            data-toggle="close"
            data-checklist-wrapper-target="checklist_container_<?php echo e($checklist->checklist_id); ?>"
            data-checklist-target="checklist-text-<?php echo e($checklist->checklist_id); ?>"
            data-textarea-target="update-checklist-textarea-<?php echo e($checklist->checklist_id); ?>"
            data-form-id="edit-checklist-text-container-<?php echo e($checklist->checklist_id); ?>"
        ...
        <button type="button" class="btn btn-danger  btn-xs x-submit-button update-checklist-submit-button"
            id="new-checklist-text-form-submit-button" data-url="<?php echo e(url('/checklists/'.$checklist->checklist_id)); ?>" data-type="form"
            data-ajax-type="put" 
            data-progress-bar="hidden"
            data-checklist-wrapper-target="checklist_container_<?php echo e($checklist->checklist_id); ?>"
            data-checklist-target="checklist-text-<?php echo e($checklist->checklist_id); ?>"
            data-form-id="edit-checklist-text-container-<?php echo e($checklist->checklist_id); ?>"
            data-loading-target="edit-checklist-text-container-<?php echo e($checklist->checklist_id); ?>">
            <?php echo app('translator')->get('lang.update'); ?>
        </button>
    </div>
</div>

<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/checklists/checklist.blade.php ENDPATH**/ ?>