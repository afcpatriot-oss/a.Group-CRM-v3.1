<div class="row" id="js-trigger-invoices-modal-add-edit" data-payload="<?php echo e($page['section'] ?? ''); ?>"
    data-due-days-text="<?php echo e($invoice_due_days_text ?? ''); ?>">
    <div class="col-lg-12">
        ...
        <div class="client-selector">
            ...
            <div class="client-selector-container hidden" id="client-new-container">
                <div class="form-group row">
                    <label
                        class="col-sm-12 col-lg-4 text-left control-label col-form-label"><?php echo e(cleanLang(__('lang.company_name'))); ?></label>
        ...
        <?php echo $__env->yieldPushContent('form_invoice_add_edit_1'); ?>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-lg-9">
                <input type="text" class="form-control  form-control-sm pickadate" name="bill_date_add_edit"
                    autocomplete="off" value="<?php echo e(runtimeDatepickerDate($invoice->bill_date ?? runtimeTodaysDate())); ?>">
                <input class="mysql-date" type="hidden" name="bill_date" id="bill_date_add_edit"
                    value="<?php echo e($invoice->bill_date ?? runtimeTodaysDateMySQL()); ?>">
            </div>
        </div>

        
        <!--module extension point - allows modules to inject form fields-->
        <?php echo $__env->yieldPushContent('form_invoice_add_edit_2'); ?>
        ...
        <div class="form-group row" id="bill_due_date_payload">
            ...
            <div class="col-sm-12 col-lg-6">
                ...
                <div id="bill_due_date_auto_container">
                    <input type="text" class="form-control form-control-sm" id="bill_due_date_display"
                        data-system-default="<?php echo e(config('system.settings2_invoices_due_days', 7)); ?>"
                        data-invoice-due-days="<?php echo e($invoice_due_days ?? config('system.settings2_invoices_due_days', 7)); ?>"
                        disabled
                        value="Invoice Date + <?php echo e($invoice_due_days ?? config('system.settings2_invoices_due_days', 7)); ?> days">
            ...
            <div class="col-sm-12 col-lg-3">
                ...
                <select class="select2-basic form-control form-control-sm select2-preselected"
                    ...
                    <option value="set_due_date_automatically"><?php echo app('translator')->get('lang.set_due_date_automatically'); ?></option>
                    <option value="set_due_date_manually"><?php echo app('translator')->get('lang.set_due_date_manually'); ?></option>
                </select>
            </div>
        </div>
        <?php endif; ?>
        ...
        <!--module extension point - allows modules to inject form fields-->
        <?php echo $__env->yieldPushContent('form_invoice_add_edit_3'); ?>
        ...
        <!--module extension point - allows modules to inject form fields-->
        <?php echo $__env->yieldPushContent('form_invoice_add_edit_4'); ?>
        ...
        <!--module extension point - allows modules to inject form fields-->
        <?php echo $__env->yieldPushContent('form_invoice_add_edit_5'); ?>

        <!--module extension point - allows modules to inject form fields-->
        <?php echo $__env->yieldPushContent('form_invoice_add_edit_main'); ?>
        ...
        <!--module extension point - allows modules to inject form fields-->
        <?php echo $__env->yieldPushContent('form_invoice_add_edit_6'); ?>
...
<script>
    NXLANG.invoice_date_plus = "<?php echo app('translator')->get('lang.invoice_date_plus'); ?>";
    NXLANG.day = "<?php echo app('translator')->get('lang.day'); ?>";
    NXLANG.days = "<?php echo app('translator')->get('lang.days'); ?>";
</script><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/invoices/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>