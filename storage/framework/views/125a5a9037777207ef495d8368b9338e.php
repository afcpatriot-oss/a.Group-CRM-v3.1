...
<div class="form-group form-group-checkbox row">
    <div class="col-12 text-left p-t-5">
        <input type="checkbox" id="contract_automation_status" name="contract_automation_status" class="filled-in chk-col-light-blue"
            <?php echo e(runtimePrechecked2('checked', config('system.settings2_contracts_automation_default_status'), 'enabled')); ?>>
        <label for="contract_automation_status"><?php echo e(cleanLang(__('lang.enable_automation'))); ?></label>
        <small class="form-text text-muted"><?php echo e(cleanLang(__('lang.automation_will_create_project_invoice'))); ?></small>
    </div>
</div>
<?php endif; ?>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/contracts/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>