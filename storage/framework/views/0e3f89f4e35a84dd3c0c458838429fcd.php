...
<div class="card">
    ...
    <?php echo $__env->yieldPushContent('left_panel_1'); ?>
    ...
    <div class="card-body profile_header">
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('left_panel_2'); ?>
    </div>
    <?php else: ?>
    <!--no logo -->
    <div class="card-body profile_header client logo-text">
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('left_panel_3'); ?>
    </div>
    <?php endif; ?>


    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('left_panel_4'); ?>
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <div>
            ...
            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('left_panel_5'); ?>
            ...
            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('left_panel_6'); ?>
        </div>
        <?php endif; ?>
    </div>
    <div>
        ...
        <div>
            <table class="table no-border m-b-0">
                <tbody>
                    ...
                    <!--module extension point - allows modules to inject content-->
                    <?php echo $__env->yieldPushContent('left_panel_7'); ?>
                </tbody>
            </table>
        </div>
    </div>
    ...
    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('left_panel_8'); ?>
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <?php endif; ?>
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('left_panel_9'); ?>
    </div>

    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('left_panel_10'); ?>
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <div class="x-each-field m-b-18">
            ...
            <div class="x-content"><?php echo clean(customFieldValue($field->customfields_name, $client,
    ...
    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('left_panel_11'); ?>
...
<!-- Column --><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/client/components/misc/leftpanel.blade.php ENDPATH**/ ?>