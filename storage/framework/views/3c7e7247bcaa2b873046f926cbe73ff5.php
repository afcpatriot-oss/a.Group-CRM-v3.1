        ...
        <div class="x-footer row">
            <div class="col-6 x-icons">
                ...
                <span title="<?php echo e(cleanLang(__('lang.star_lead'))); ?>"
                    class="x-icon vm p-t-2 data-toggle-action-tooltip opacity-4 font-14 ajax-request <?php echo e($lead->is_starred ? 'hidden' : ''); ?> starred-star-button-<?php echo e($lead->lead_id); ?>"
                    id="starred-star-button-<?php echo e($lead->lead_id); ?>" data-stop-propagation="yes"
                    data-url="<?php echo e(url('/starred/togglestatus?action=star&resource_type=lead&resource_id='.$lead->lead_id)); ?>"
                    data-loading-target="starred-star-button-<?php echo e($lead->lead_id); ?>" data-ajax-type="POST"
                ...
                <span title="<?php echo e(cleanLang(__('lang.unstar_lead'))); ?>"
                    class="x-icon vm p-t-2 data-toggle-action-tooltip font-14 ajax-request text-warning <?php echo e(!$lead->is_starred ? 'hidden' : ''); ?> starred-unstar-button-<?php echo e($lead->lead_id); ?>"
                    id="starred-unstar-button-<?php echo e($lead->lead_id); ?>" data-stop-propagation="yes"
                    data-url="<?php echo e(url('/starred/togglestatus?action=unstar&resource_type=lead&resource_id='.$lead->lead_id)); ?>"
                    data-loading-target="starred-unstar-button-<?php echo e($lead->lead_id); ?>" data-ajax-type="POST"
                    data-on-start-submit-button="disable">
                    <i class="sl-icon-star"></i>
                </span>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/leads/components/kanban/card.blade.php ENDPATH**/ ?>