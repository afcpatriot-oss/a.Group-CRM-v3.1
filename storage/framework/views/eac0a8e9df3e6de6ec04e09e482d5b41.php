...
<?php echo $__env->yieldPushContent('section_task_right_panel_one'); ?>
...
<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('section_task_right_panel_two'); ?>
...
<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('section_task_right_panel_tree'); ?>
...
<div class="x-section">
    ...
    <div class="x-element" id="card-task-priority"><i class="mdi mdi-flag"></i>
        ...
        <span class="x-highlight x-editable js-card-settings-button-static" data-container=".card-modal"
            ...
            data-status-id="<?php echo e($task->taskpriority_id); ?>"
    ...
    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('action_task_settings'); ?>
...
<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('section_task_right_panel_four'); ?>
...
<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('section_task_right_panel_five'); ?>
...
<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('action_task_dependencies'); ?>

<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('section_task_right_panel_six'); ?>
...
<div class="x-section">
    ...
    <div class="x-element x-action js-card-settings-button-static" data-container=".card-modal" id="card-task-milestone"
        tabindex="0" data-popover-content="card-task-milestones" data-title="<?php echo e(cleanLang(__('lang.milestone'))); ?>"><i
    ...
    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('action_task_actions'); ?>
...
<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('section_task_right_panel_seven'); ?>
    ...
    <div class="x-element x-action">
        <table class="table table-bordered table-sm">
            <tbody>
                ...
                <?php echo $__env->yieldPushContent('section_task_right_panel_information_table_row'); ?>
...
<!--module extension point - allows modules to inject content-->
<?php echo $__env->yieldPushContent('section_task_right_panel_eight'); ?>
...
<div class="hidden" id="card-task-statuses">
    <ul class="list">
        ...
        <li class="card-tasks-update-status-link" data-button-text="card-task-status-text" data-progress-bar='hidden'
            ...
            data-value="<?php echo e($task_status->taskstatus_id); ?>" data-form-id="--set-dynamically--" data-ajax-type="post">
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/task/rightpanel.blade.php ENDPATH**/ ?>