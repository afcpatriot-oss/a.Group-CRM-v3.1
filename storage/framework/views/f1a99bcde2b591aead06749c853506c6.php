<!DOCTYPE html>
<html lang="en" class="<?php echo e(auth()->user()->type ?? ''); ?> <?php echo e(config('visibility.page_rendering')); ?> <?php echo e(config('active_theme')); ?>" data-bs-theme="<?php echo e(config('active_theme')); ?>">

<!--CRM - GROWCRM.IO-->
<?php echo $__env->make('layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<body id="main-body" data-main-menu-id="<?php echo e($page['main_menu_id'] ?? ''); ?>" data-sub-menu-id="<?php echo e($page['sub_menu_id'] ?? ''); ?>"
...
</html><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/layout/wrapper.blade.php ENDPATH**/ ?>