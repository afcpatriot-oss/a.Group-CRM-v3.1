        ...
        <div class="col-xl-9 col-lg-12">
            <div class="card h-100">
                ...
                <div class="tab-content">
                    ...
                    <?php echo $__env->yieldPushContent('section_client_wrapper_dynamic'); ?>
...
<?php echo $__env->make('layout.wrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/client/wrapper.blade.php ENDPATH**/ ?>