...
<tr id="timesheet_<?php echo e($timesheet->timer_id); ?>">
    ...
    <td class="timesheets_col_user">
        ...
        <span class="hidden printing_visible">
            <?php echo e($timesheet->first_name ?? runtimeUnkownUser()); ?> <?php echo e($timesheet->last_name ?? ''); ?>
    ...
    <td class="timesheets_col_recorded_by"><?php echo e($timesheet->recorded_by); ?></td>
    <?php endif; ?>

    <!--date-->
    <td class="timesheets_col_start_date"><?php echo e(runtimeDate($timesheet->timer_created)); ?></td>

    <!--time-->
    <?php if(config('visibility.timesheets_col_start_time')): ?>
    <td class="timesheets_col_start_time"><?php echo e(runtimeTime($timesheet->timer_created)); ?></td>
    <?php endif; ?>
    ...
    <td class="timesheets_col_action actions_column">
        <span class="list-table-action dropdown  font-size-inherit">
            ...
            <button type="button" title="<?php echo e(cleanLang(__('lang.edit'))); ?>"
                ...
                data-url="<?php echo e(urlResource('/timesheets/'.$timesheet->timer_id.'/edit')); ?>"
                data-loading-target="commonModalBody" data-modal-title="<?php echo e(cleanLang(__('lang.edit_timesheet'))); ?>"
            ...
            <?php endif; ?>
            <?php if($timesheet->timer_billing_status == 'invoiced'): ?>
            <a href="<?php echo e(url('/invoices/'.$timesheet->timer_billing_invoiceid)); ?>"
...
<!--each row-->
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/timesheets/components/table/ajax.blade.php ENDPATH**/ ?>