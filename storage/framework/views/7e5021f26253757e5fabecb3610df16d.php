...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <button type="button" title="<?php echo e(cleanLang(__('lang.import_items'))); ?>" id="items-import-button"
            ...
            data-action-url="<?php echo e(url('import/items')); ?>" data-action-method="POST"
            data-loading-target="commonModalBody" data-action-ajax-loading-target="commonModalBody"
            data-modal-title="<?php echo app('translator')->get('lang.import_items'); ?>" data-url="<?php echo e(url('import/items/create')); ?>">
            <i class="ti-import"></i>
        </button>
        <?php endif; ?>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/items/components/misc/list-page-actions.blade.php ENDPATH**/ ?>