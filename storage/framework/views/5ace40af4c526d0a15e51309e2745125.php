<div class="row project-details" id="project-details-container">
    <div class="col-sm-12 tinymce-transparent">
        ...
        <?php echo $__env->yieldPushContent('section_project_details_1'); ?>

        <!--textarea & editor area-->
        <div class="project-description p-0 p-t-40 rich-text-formatting" id="project-description">

            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('section_project_details_2'); ?>

            <?php echo $project->project_description; ?>


            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('section_project_details_3'); ?>
        </div>
        <!--dynamic description field-->
        <input type="hidden" name="description" id="description" value="">

        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('section_project_details_4'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('section_project_details_5'); ?>
        ...
        <div id="project-description-edit" class="p-t-20 text-right">
            ...
            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('section_project_details_6'); ?>
        ...
        <div id="project-description-submit" class="p-t-20 hidden text-right">
            ...
            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('section_project_details_7'); ?>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/project/components/tabs/details.blade.php ENDPATH**/ ?>