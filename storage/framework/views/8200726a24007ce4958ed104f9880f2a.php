...
<div class="filtered-results-warning opacity-8 p-b-5">
    <small>
        ...
        <a href="javascript:void(0);" class="js-toggle-side-panel" data-target="sidepanel-filter-invoices"><?php echo app('translator')->get('lang.filtered'); ?></a>.
        <?php echo app('translator')->get('lang.you_can'); ?>
        <a href="<?php echo e(url('/invoices?clear-filter=yes')); ?>"><?php echo app('translator')->get('lang.clear_the_filters'); ?></a>.
    </small>
</div>
<?php endif; ?>
            ...
            <table id="invoices-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list"
                ...
                <thead>
                    <tr>
                        ...
                        <th
                            class="invoices_col_tableconfig_column_23 <?php echo e(config('table.tableconfig_column_23')); ?> tableconfig_column_23">
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/invoices/components/table/table.blade.php ENDPATH**/ ?>