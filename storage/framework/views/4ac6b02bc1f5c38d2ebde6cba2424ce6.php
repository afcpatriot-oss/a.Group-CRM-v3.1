    ...
    <div class="x-section">
        ...
        <div class="x-element text-center font-14" id="card-lead-element-container-name">
            ...
            <span class="x-highlight x-editable js-card-settings-button-static" id="card-lead-name" data-container=".card-modal" tabindex="0"
                ...
                <span id="card-lead-firstname-containter" class="card-lead-firstname-containter"><?php echo e($lead->lead_firstname); ?></span> <span
                    id="card-lead-lastname-containter" class="card-lead-lastname-containter"><?php echo e($lead->lead_lastname); ?></span></span>
                <?php else: ?>
                    <span id="card-lead-firstname-containter"><?php echo app('translator')->get('lang.add_contact'); ?></span> <span
    ...
    </div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/lead/rightpanel.blade.php ENDPATH**/ ?>