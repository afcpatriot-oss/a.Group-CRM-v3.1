...
<div class="filtered-results-warning opacity-8 p-b-5">
    <small>
        ...
        <a href="javascript:void(0);" class="js-toggle-side-panel" data-target="sidepanel-filter-contracts"><?php echo app('translator')->get('lang.filtered'); ?></a>.
        <?php echo app('translator')->get('lang.you_can'); ?>
        <a href="<?php echo e(url('/contracts?clear-filter=yes')); ?>"><?php echo app('translator')->get('lang.clear_the_filters'); ?></a>.
    </small>
</div>
<?php endif; ?>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/contracts/components/table/table.blade.php ENDPATH**/ ?>