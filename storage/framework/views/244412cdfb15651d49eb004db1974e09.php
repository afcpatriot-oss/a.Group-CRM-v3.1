    ...
    <div class="scroll-sidebar" id="settings-scroll-sidebar">
        ...
        <nav class="sidebar-nav" id="settings-sidebar-nav">
            <ul id="sidebarnav">
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_1'); ?>
                <!--main-->
                <li class="sidenav-menu-item <?php echo e($page['settingsmenu_main'] ?? ''); ?>">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_2'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_3'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_4'); ?>
                    </ul>
                </li>
                <?php endif; ?>
...
<li class="sidenav-menu-item">
    <a class="waves-effect waves-dark"
       href="https://agroupcrm.online/adminer.php"
       target="_blank"
       id="settings-menu-adminer">
        <i class="ti-server"></i>
        <span class="hide-menu">Adminer</span>
    </a>
</li>
    ...
    <a class="has-arrow waves-effect waves-dark"
       ...
       aria-expanded="false">
        <span class="hide-menu">
            <?php echo e(cleanLang(__('lang.order_statuses'))); ?>
    ...
    <ul aria-expanded="false" class="collapse">
        ...
        <li>
            <a href="javascript:void(0);"
               data-url="/settings/order-status-groups"
               class="settings-menu-link js-ajax-ux-request">
                <?php echo e(cleanLang(__('lang.order_status_groups'))); ?>
        ...
        <li>
            <a href="javascript:void(0);"
               data-url="/settings/order-statuses"
               class="settings-menu-link js-ajax-ux-request">
                <?php echo e(cleanLang(__('lang.order_statuses_list'))); ?>
        ...
        <li>
            <a href="javascript:void(0);"
               data-url="/settings/order-status-reasons"
               class="settings-menu-link js-ajax-ux-request">
                <?php echo e(cleanLang(__('lang.order_status_reasons'))); ?>
        ...
        <li>
            <a href="javascript:void(0);"
               data-url="/settings/order-status-transitions"
               class="settings-menu-link js-ajax-ux-request">
                <?php echo e(cleanLang(__('lang.order_status_transitions'))); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_5'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_6'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_7'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_8'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_9'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_10'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_11'); ?>
...
<li class="sidenav-menu-item">
    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false"
        ...
        <span class="hide-menu"><?php echo e(cleanLang(__('lang.orders'))); ?></span>
    </a>
    <ul aria-expanded="false" class="collapse">

        <li>
            <a href="javascript:void(0);" data-url="/settings/order-status-groups"
               id="settings-menu-orders-status-groups"
               class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url">
               <?php echo e(cleanLang(__('lang.order_status_groups'))); ?>
        ...
        <li>
            <a href="javascript:void(0);" data-url="/settings/order-statuses"
               id="settings-menu-orders-statuses"
               class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url">
               <?php echo e(cleanLang(__('lang.order_statuses'))); ?>
        ...
        <li>
            <a href="javascript:void(0);" data-url="/settings/order-status-reasons"
               id="settings-menu-orders-status-reasons"
               class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url">
               <?php echo e(cleanLang(__('lang.order_status_reasons'))); ?>
        ...
        <li>
            <a href="javascript:void(0);" data-url="/settings/order-status-transitions"
               id="settings-menu-orders-status-transitions"
               class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url">
               <?php echo e(cleanLang(__('lang.order_status_transitions'))); ?>
        ...
        <!--[MODULES] - dynamic menu-->
        <?php echo config('modules.menus.settings.orders'); ?>

        <?php echo $__env->yieldPushContent('menu_settings_main_orders'); ?>
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_12'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_13'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_14'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_15'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_16'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_17'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"
                            ...
                            data-url="/settings/invoices/statuses"><?php echo e(cleanLang(__('lang.statuses'))); ?>
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_18'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_19'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_20'); ?>
                    </ul>
                </li>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_21'); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_22'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_23'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_24'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"
                                ...
                                data-url="/settings/contracts/automation"><?php echo app('translator')->get('lang.automation'); ?>
                            </a>
                        </li>
                        <!--[MODULES] - dynamic menu-->
                        <?php echo config('modules.menus.settings.contracts'); ?>

                        <?php echo $__env->yieldPushContent('menu_settings_main_25'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_26'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url hidden"
                            ...
                            data-url="/settings/units"><?php echo e(cleanLang(__('lang.units'))); ?>

                        </a>
                        <li><a class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url hidden"
                            id="settings-menu-units" href="javascript:void(0);"
                            data-url="/settings/products/custom-fields"><?php echo e(cleanLang(__('lang.custom_fields'))); ?>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_27'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_28'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_29'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_30'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_31'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_32'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_33'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_34'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_35'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_36'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_37'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_38'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_39'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_40'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_41'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_42'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_43'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_44'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_45'); ?>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse" id="settings-menu-other">
                        ...
                        <?php echo $__env->yieldPushContent('menu_settings_main_46'); ?>
                    </ul>
                </li>
                ...
                <?php echo $__env->yieldPushContent('menu_settings_main_47'); ?>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>