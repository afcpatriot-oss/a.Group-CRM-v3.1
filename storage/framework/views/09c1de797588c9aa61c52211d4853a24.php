...
<tr id="lead_<?php echo e($lead->lead_id); ?>" class=" <?php echo e($lead->pinned_status ?? ''); ?>">
    ...
    <td class="leads_col_action actions_column" id="leads_col_action_<?php echo e($lead->lead_id); ?>">
        ...
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.star_lead'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm opacity-4 ajax-request <?php echo e($lead->is_starred ? 'hidden' : ''); ?> starred-star-button-<?php echo e($lead->lead_id); ?>"
        ...
        <!--unstar button-->
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.unstar_lead'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm ajax-request text-warning <?php echo e(!$lead->is_starred ? 'hidden' : ''); ?> starred-unstar-button-<?php echo e($lead->lead_id); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/leads/components/table/ajax.blade.php ENDPATH**/ ?>