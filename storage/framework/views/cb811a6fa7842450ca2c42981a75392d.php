                ...
                <li class="nav-item dropdown hidden-mobile">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item js-toggle-side-panel-ajax" href="javascript:void(0);"
                            ...
                            <i class="ti-wallet p-r-4"></i> <?php echo app('translator')->get('lang.invoices'); ?>
                        </a>
                        ...
                        <a class="dropdown-item js-toggle-side-panel-ajax" href="javascript:void(0);"
                            ...
                            <i class="ti-receipt p-r-4"></i> <?php echo app('translator')->get('lang.estimates'); ?>
                        </a>
                        ...
                        <a class="dropdown-item js-toggle-side-panel-ajax" href="javascript:void(0);"
                            ...
                            <i class="sl-icon-call-in p-r-4"></i> <?php echo app('translator')->get('lang.leads'); ?>
                        </a>
...
</header><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>