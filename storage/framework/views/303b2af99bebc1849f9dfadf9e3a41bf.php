...
<div class="card" id="project_details" data-progress="<?php echo e($project->project_progress); ?>">
    ...
    <?php echo $__env->yieldPushContent('section_project_details_top'); ?>
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <!--module integration point-->
        <?php echo $__env->yieldPushContent('section_project_details_client'); ?>
    ...
    <div class="card-body p-t-0 p-b-0">
        <div class="row">
            ...
            <!--module integration point-->
            <?php echo $__env->yieldPushContent('section_project_details_dates'); ?>
        </div>
    </div>
    <div class="m-t-10 m-b-10">
        <hr>
    ...
    <div class="card-body p-t-0 p-b-0">
        <div class="row">
            ...
            <!--module integration point-->
            <?php echo $__env->yieldPushContent('section_project_details_billing'); ?>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="card-body p-t-0 p-b-0">
        ...
        <!--module integration point-->
        <?php echo $__env->yieldPushContent('section_project_details_invoices'); ?>
    </div>
    <?php endif; ?>

    <!--module integration point-->
    <?php echo $__env->yieldPushContent('section_project_details_main'); ?>
    ...
    <!--module integration point-->
    <?php echo $__env->yieldPushContent('section_project_details_end'); ?>

    <div class="d-none last-line">
        <hr>
    </div>
</div>
<!-- Column --><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/project/components/misc/details.blade.php ENDPATH**/ ?>