        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <div class="dropdown-menu" aria-labelledby="listTableAction">
                    ...
                    <?php if($contact->account_owner == 'no'): ?>
                    <a title="<?php echo app('translator')->get('lang.set_as_account_owner'); ?>" href="javascript:void(0);"
                        class="dropdown-item confirm-action-info"
                        data-confirm-title="<?php echo app('translator')->get('lang.confirm_set_account_owner'); ?>"
                        data-confirm-text="<?php echo app('translator')->get('lang.confirm_set_account_owner_text'); ?>"
                        data-url="<?php echo e(url('contacts/'.$contact->id.'/update-account-owner')); ?>"
                        data-ajax-type="POST">
                        <?php echo app('translator')->get('lang.set_as_account_owner'); ?>
                    </a>
                    <?php endif; ?>
                </div>
            </span>
...
<!--each row--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/contacts/components/table/ajax.blade.php ENDPATH**/ ?>