...
<tr id="invoice_<?php echo e($invoice->bill_invoiceid); ?>" class="<?php echo e($invoice->pinned_status ?? ''); ?>">
    ...
    <td class="invoices_col_tableconfig_column_23 <?php echo e(config('table.tableconfig_column_23')); ?> tableconfig_column_23"
        ...
        <span class="label <?php echo e(runtimeInvoiceStatusColors($invoice->bill_status, 'label')); ?>"><?php echo e(runtimeInvoiceStatusTitle($invoice->bill_status)); ?></span>
    ...
    <td class="invoices_col_action actions_column" id="invoices_col_action_<?php echo e($invoice->bill_invoiceid); ?>">
        ...
        <span class="list-table-action font-size-inherit">
            ...
            <span class="list-table-action dropdown font-size-inherit">
                ...
                <div class="dropdown-menu" aria-labelledby="listTableAction">
                    ...
                    <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form"
                        ...
                        data-url="<?php echo e(url('/invoices/'.$invoice->bill_invoiceid.'/change-status')); ?>"
                        data-action-url="<?php echo e(url('invoices/'.$invoice->bill_invoiceid.'/change-status')); ?>"
                        data-loading-target="actionsModalBody" data-action-method="POST"
                        data-modal-title="<?php echo app('translator')->get('lang.change_invoice_status'); ?>">
                        <?php echo app('translator')->get('lang.change_invoice_status'); ?></a>
                    <?php endif; ?>
                    <!--overdue invoice reminder-->
                    <?php if(auth()->user()->role->role_invoices > 1 && $invoice->bill_status == 3): ?>
                    <a class="dropdown-item confirm-action-info" href="javascript:void(0)"
            ...
            <span class="list-table-action">
                <button type="button" title="<?php echo e(cleanLang(__('lang.star_invoice'))); ?>"
                    class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm opacity-4 ajax-request <?php echo e($invoice->is_starred ? 'hidden' : ''); ?> starred-star-button-<?php echo e($invoice->bill_invoiceid); ?>"
                    id="starred-star-button-<?php echo e($invoice->bill_invoiceid); ?>"
                    data-url="<?php echo e(url('/starred/togglestatus?action=star&resource_type=invoice&resource_id='.$invoice->bill_invoiceid)); ?>"
                    data-loading-target="starred-star-button-<?php echo e($invoice->bill_invoiceid); ?>" data-ajax-type="POST"
            ...
            <!--unstar button-->
            <span class="list-table-action">
                <button type="button" title="<?php echo e(cleanLang(__('lang.unstar_invoice'))); ?>"
                    class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm ajax-request text-warning <?php echo e(!$invoice->is_starred ? 'hidden' : ''); ?> starred-unstar-button-<?php echo e($invoice->bill_invoiceid); ?>"
                    id="starred-unstar-button-<?php echo e($invoice->bill_invoiceid); ?>"
                    data-url="<?php echo e(url('/starred/togglestatus?action=unstar&resource_type=invoice&resource_id='.$invoice->bill_invoiceid)); ?>"
                    data-loading-target="starred-unstar-button-<?php echo e($invoice->bill_invoiceid); ?>" data-ajax-type="POST"
                    data-on-start-submit-button="disable">
                    <i class="sl-icon-star"></i>
                </button>
            </span>
...
<!--each row--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/invoices/components/table/ajax.blade.php ENDPATH**/ ?>