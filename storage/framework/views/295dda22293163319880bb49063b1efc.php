<div id="bill-form-container">
    <div class="card card-body invoice-wrapper box-shadow" id="invoice-wrapper">
        ...
        <?php if($bill->bill_status == 1 && $bill->bill_publishing_type == 'scheduled'): ?>
        ...
        <div class="row">
                ...
                <div class="pull-left">
                    <address>
                        ...
                        <p class="text-muted m-l-5">
                            ...
                            <?php echo $__env->yieldPushContent('bill_position_5'); ?>
                        </p>
                    </address>
                </div>
                <!--client address-->
                <div class="pull-right text-right">
                    <address>
                        ...
                        <p class="text-muted m-l-30">
                            ...
                            <!--module extension point-->
                            <?php echo $__env->yieldPushContent('bill_position_6'); ?>
                        </p>
                    </address>
                </div>
            </div>
            ...
            <div class="col-12 m-b-10 billing-mode-only-item invoice-project-title">
                ...
                <!--module extension point-->
                <?php echo $__env->yieldPushContent('bill_position_7'); ?>
            </div>
            <?php endif; ?>
            ...
            <!--module extension point-->
            <?php echo $__env->yieldPushContent('bill_position_14'); ?>
            <?php endif; ?>
            <?php if($bill->bill_type == 'estimate'): ?>
            <div class="col-12 m-b-10 billing-mode-only-item" id="invoice-dates-wrapper">
            ...
            <!--module extension point-->
            <?php echo $__env->yieldPushContent('bill_position_15'); ?>
            <?php endif; ?>

            <!--module extension point-->
            <?php echo $__env->yieldPushContent('bill_position_16'); ?>
            ...
            <!--module extension point-->
            <?php echo $__env->yieldPushContent('bill_position_17'); ?>
            ...
            <!--module extension point-->
            <?php echo $__env->yieldPushContent('bill_position_20'); ?>

            <!-- TOTAL & SUMMARY -->
            <?php if($bill->bill_tax_type == 'inline'): ?>
            <?php echo $__env->make('pages.bill.components.elements.totals-inline', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php else: ?>
            <?php echo $__env->make('pages.bill.components.elements.totals-summary', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
            ...
            <!--module extension point-->
            <?php echo $__env->yieldPushContent('bill_position_23'); ?>
            ...
            <div class="col-12 billing-mode-only-item">
                ...
                <!--module extension point-->
                <?php echo $__env->yieldPushContent('bill_position_24'); ?>
                ...
                <!--module extension point-->
                <?php echo $__env->yieldPushContent('bill_position_33'); ?>
                ...
                <!--module extension point-->
                <?php echo $__env->yieldPushContent('bill_position_34'); ?>
            </div>
            <!--module extension point-->
            <?php echo $__env->yieldPushContent('bill_position_35'); ?>
        </div>

        <!--module extension point-->
        <?php echo $__env->yieldPushContent('bill_position_36'); ?>
    ...
    <?php endif; ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/bill/bill-web.blade.php ENDPATH**/ ?>