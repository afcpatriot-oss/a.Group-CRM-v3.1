<div class="row">
    <div class="col-lg-12">
        ...
        <ul data-modular-id="project_tabs_menu" class="nav nav-tabs profile-tab project-top-nav list-pages-crumbs"
            ...
            <?php echo $__env->yieldPushContent('menu_project_topnav_start'); ?>
            ...
            <li data-modular-id="project_tabs_menu_financial"
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <!--module integration point-->
                    <?php echo $__env->yieldPushContent('menu_project_topnav_financial'); ?>
                </div>
            </li>
            <?php endif; ?>

            <!--module integration point-->
            <?php echo $__env->yieldPushContent('menu_project_topnav_end'); ?>
            ...
            <li data-modular-id="project_tabs_menu_more" class="nav-item dropdown <?php echo e($page['tabmenu_more'] ?? ''); ?>">
                ...
                <div class="dropdown-menu" x-placement="bottom-start" id="fx-topnav-dropdown">
                    ...
                    <!--module integration point-->
                    <?php echo $__env->yieldPushContent('menu_project_topnav_more'); ?>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/project/components/misc/topnav.blade.php ENDPATH**/ ?>