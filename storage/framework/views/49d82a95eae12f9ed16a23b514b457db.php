<div class="card-description" id="card-description">
    ...
    <?php echo $__env->yieldPushContent('section_task_description'); ?>

    <?php if($task->permission_edit_task): ?>
    <!--buttons: edit-->
    <div id="card-description-edit">
        <div class="x-action" id="card-description-button-edit">
            <a href="javaScript:void(0);" class="display-inline-block"><?php echo e(cleanLang(__('lang.edit_description'))); ?></a>

            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('actions_task_description'); ?>
    ...
    <div id="card-description-submit" class="p-t-10 hidden text-right">
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_task_description_new'); ?>
    </div>
    <?php endif; ?>
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/task/components/description.blade.php ENDPATH**/ ?>