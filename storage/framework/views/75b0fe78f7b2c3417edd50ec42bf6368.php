        ...
        <div class="slimscrollright">
            ...
            <div class="r-panel-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="filter_client_categoryid" id="filter_client_categoryid"
                                    ...
                                    <option value="<?php echo e($category->category_id); ?>"
                                        <?php echo e(in_array($category->category_id, $saved_categories) ? 'selected' : ''); ?>>
                            ...
                            <div class="col-md-12">
                                ...
                                <select name="filter_tags" id="filter_tags"
                                    ...
                                    <option value="<?php echo e($tag->tag_title); ?>"
                                        <?php echo e(in_array($tag->tag_title, $saved_tags) ? 'selected' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <input type="text" name="filter_date_created_start"
                                    ...
                                    value="<?php echo e(runtimeDatepickerDate(config('filter.saved_data.filter_date_created_start') ?? '')); ?>">
                                <input class="mysql-date" type="hidden" name="filter_date_created_start"
                                    id="filter_date_created_start"
                                    value="<?php echo e(config('filter.saved_data.filter_date_created_start') ?? ''); ?>">
                            </div>
                            <div class="col-md-6">
                                <input type="text" name="filter_date_created_end" autocomplete="off"
                                    ...
                                    value="<?php echo e(runtimeDatepickerDate(config('filter.saved_data.filter_date_created_end') ?? '')); ?>">
                                <input class="mysql-date" type="hidden" name="filter_date_created_end"
                                    id="filter_date_created_end"
                                    value="<?php echo e(config('filter.saved_data.filter_date_created_end') ?? ''); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select name="filter_client_status" id="filter_client_status"
                                    ...
                                    multiple="multiple" tabindex="-1" aria-hidden="true">
                                    <option value="active" <?php echo e(in_array('active', $saved_status) ? 'selected' : ''); ?>>
                                        <?php echo e(cleanLang(__('lang.active'))); ?></option>
                                    <option value="suspended"
                                        <?php echo e(in_array('suspended', $saved_status) ? 'selected' : ''); ?>>
                                        <?php echo e(cleanLang(__('lang.suspended'))); ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="buttons-block">
                    <a href="<?php echo e(url('/clients?clear-filter=yes')); ?>"
...
<!--sidebar--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/clients/components/misc/filter-clients.blade.php ENDPATH**/ ?>