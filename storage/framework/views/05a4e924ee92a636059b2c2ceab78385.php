<ul class="nav nav-tabs customtab" role="tablist">
    ...
    <!--css_style-->
    <li class="nav-item"> <a class="nav-link cursor-pointer <?php echo e($page['menutab_style'] ?? ''); ?>"
            href="<?php echo e(url('/app/settings/formbuilder/'.$webform->webform_id.'/style')); ?>" role="tab"><span
                class="hidden-sm-up"><i class="ti-email"></i></span> <span
                class="hidden-xs-down"><?php echo app('translator')->get('lang.css_style'); ?></span></a>
    </li>
    <!--embed code-->
...
</ul><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/settings/sections/formbuilder/misc/tabs.blade.php ENDPATH**/ ?>