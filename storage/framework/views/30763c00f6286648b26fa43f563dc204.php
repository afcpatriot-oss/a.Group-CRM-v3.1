...
<div class="col-md-12  col-lg-6 align-self-center text-right parent-page-actions p-b-9"
    ...
    <div id="list-page-actions">
        ...
        <?php echo $__env->yieldPushContent('menu_project_actions_start'); ?>
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <!--module integration point-->
                <?php echo $__env->yieldPushContent('menu_project_actions_edit'); ?>
        ...
        <!--module integration point-->
        <?php echo $__env->yieldPushContent('menu_project_actions_end'); ?>
...
<!-- action buttons --><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/project/components/misc/actions.blade.php ENDPATH**/ ?>