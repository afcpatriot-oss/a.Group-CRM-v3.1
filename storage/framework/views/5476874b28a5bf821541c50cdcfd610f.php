...
<tr id="task_<?php echo e($task->task_id); ?>"
    class="<?php echo e(runtimeTaskCompletedStatus($task->task_status)); ?> <?php echo e($task->pinned_status ?? ''); ?>">
    <td class="tasks_col_title td-edge">
        ...
        <span class="list-checkboxes m-l-0">
            <input type="checkbox" id="toggle_task_status_<?php echo e($task->task_id); ?>" name="toggle_task_status"
                ...
                data-task-status="<?php echo e($task->task_status); ?>" <?php echo e(runtimePrechecked($task->task_status)); ?>
    ...
    <td class="tasks_col_priority">
        <span class="label label-outline-<?php echo e($task->taskpriority_color); ?>"><?php echo e($task->taskpriority_title); ?></span>
    </td>
    <?php endif; ?>
    ...
    <td class="tasks_col_action actions_column">
        ...
        <span class="list-table-action">
            <a href="javascript:void(0);" title="<?php echo e(cleanLang(__('lang.pinning'))); ?>"
                data-parent="task_<?php echo e($task->task_id); ?>" data-url="<?php echo e(url('/tasks/'.$task->task_id.'/pinning')); ?>"
        ...
        <!--star button-->
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.star_task'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm opacity-4 ajax-request <?php echo e($task->is_starred ? 'hidden' : ''); ?> starred-star-button-<?php echo e($task->task_id); ?>"
        ...
        <!--unstar button-->
        <span class="list-table-action">
            <button type="button" title="<?php echo e(cleanLang(__('lang.unstar_task'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-default btn-circle btn-sm ajax-request text-warning <?php echo e(!$task->is_starred ? 'hidden' : ''); ?> starred-unstar-button-<?php echo e($task->task_id); ?>"
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/tasks/components/table/ajax.blade.php ENDPATH**/ ?>