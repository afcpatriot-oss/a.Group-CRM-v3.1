            ...
            <div class="rpanel-title">
                ...
                <div class="x-top-nav">
                    ...
                    <a class="right-sidepanel-menu ajax-request" href="javascript:void(0);" id="starred-invoices"
                        data-url="<?php echo e(url('/starred/view/invoices?orderby=bill_date&sortorder=desc')); ?>"
                        data-loading-target="sidepanel-starred-container" data-target="sidepanel-starred-container"
                        data-progress-bar='hidden'><?php echo app('translator')->get('lang.invoices'); ?></a>
                    <span class="x-spacer">|</span>

                    <!--estimates-->
                    <a class="right-sidepanel-menu ajax-request" href="javascript:void(0);" id="starred-estimates"
                        data-url="<?php echo e(url('/starred/view/estimates?orderby=bill_date&sortorder=desc')); ?>"
                        data-loading-target="sidepanel-starred-container" data-target="sidepanel-starred-container"
                        data-progress-bar='hidden'><?php echo app('translator')->get('lang.estimates'); ?></a>
                    <span class="x-spacer">|</span>

                    <!--leads-->
                    <a class="right-sidepanel-menu ajax-request" href="javascript:void(0);" id="starred-leads"
                        data-url="<?php echo e(url('/starred/view/leads?orderby=lead_title&sortorder=asc')); ?>"
                        data-loading-target="sidepanel-starred-container" data-target="sidepanel-starred-container"
                        data-progress-bar='hidden'><?php echo app('translator')->get('lang.leads'); ?></a>
                    <span class="x-spacer">|</span>
...
<!--sidebar--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/starred/panel.blade.php ENDPATH**/ ?>