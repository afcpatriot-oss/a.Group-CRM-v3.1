<div class="row client-details" id="client-details-container">
    <div class="col-sm-12 tinymce-transparent">
        ...
        <?php echo $__env->yieldPushContent('details_1'); ?>
        ...
        <div class="client-description p-0 rich-text-formatting" id="client-description"> <?php echo clean($client->client_description); ?>
            ...
            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('details_2'); ?>
        </div>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('details_3'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('details_4'); ?>
        ...
        <div id="client-description-edit" class="p-t-20 text-right">
            ...
            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('details_buttons_1'); ?>
        </div>
        ...
        <div id="client-description-submit" class="p-t-20 hidden text-right">
            ...
            <!--module extension point - allows modules to inject content-->
            <?php echo $__env->yieldPushContent('details_buttons_2'); ?>

        </div>
        <?php endif; ?>

    </div>
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/client/components/tabs/details.blade.php ENDPATH**/ ?>