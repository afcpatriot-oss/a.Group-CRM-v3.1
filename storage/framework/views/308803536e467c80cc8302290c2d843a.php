    ...
    <form id="table-config-form">
        <div class="slimscrollright">
            ...
            <div class="r-panel-body table-config-ajax" data-url="<?php echo e(url('preferences/tables')); ?>" data-type="form"
                ...
                <?php echo $__env->yieldPushContent('config_panel_1'); ?>
                ...
                <div class="p-b-5">
                    <label class="custom-control custom-checkbox table-config-checkbox-container">
                        ...
                        <span class="custom-control-indicator"></span>
                        <span class="custom-control-description"><?php echo app('translator')->get('lang.name'); ?></span>
                    </label>
                </div>
        ...
        <div class="p-b-5">
            <label class="custom-control custom-checkbox table-config-checkbox-container">
                ...
                <!--module extension point - allows modules to inject content-->
                <?php echo $__env->yieldPushContent('config_panel_2'); ?>
...
<!--sidebar--><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/clients/components/misc/table-config.blade.php ENDPATH**/ ?>