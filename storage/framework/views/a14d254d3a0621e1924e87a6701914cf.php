...
<div class="col-md-12  col-lg-7 p-b-9 align-self-center text-right <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <?php echo $__env->yieldPushContent('actions_nav_1'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_2'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_3'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_4'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_5'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_6'); ?>
        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right fx-kaban-sorting-dropdown">
                ...
                <!--module extension point - allows modules to inject content-->
                <?php echo $__env->yieldPushContent('actions_nav_menu_kanban_sorting'); ?>
            </div>
        </div>

        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_7'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_8'); ?>
        <!--FILTERING-->
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_9'); ?>
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('actions_nav_10'); ?>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/tasks/components/misc/list-page-actions.blade.php ENDPATH**/ ?>