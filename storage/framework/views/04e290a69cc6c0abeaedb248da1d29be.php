...
<ul class="nav nav-tabs" role="tablist">
        ...
        <?php echo $__env->yieldPushContent('menu_task_tabs_start'); ?>
        ...
        <li class="nav-item"> <a class="nav-link ajax-request" data-toggle="tab" href="javascript:void(0);" role="tab"
                        ...
                        <span class="sl-icon-refresh font-13 vm text-danger p-l-5 <?php echo e(runtimeTaskRecurringIcon($task->task_recurring)); ?>"
        ...
        <!--module extension point - allows modules to inject content-->
        <?php echo $__env->yieldPushContent('menu_task_tabs_end'); ?>
</ul>
<?php endif; ?><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/task/content/tabmenu.blade.php ENDPATH**/ ?>