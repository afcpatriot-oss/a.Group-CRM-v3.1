...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9 <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        ...
        <?php if(auth()->user()->role->role_invoices > 1 && $bill->bill_status == 3): ?>
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                ...
                <a class="dropdown-item actions-modal-button js-ajax-ux-request reset-target-modal-form"
                    ...
                    data-url="<?php echo e(url('/invoices/'.$bill->bill_invoiceid.'/change-status')); ?>"
                    data-action-url="<?php echo e(url('invoices/'.$bill->bill_invoiceid.'/change-status')); ?>"
                    ...
                    <i class="sl-icon-settings display-inline-block p-r-5"></i><?php echo app('translator')->get('lang.change_invoice_status'); ?></a>
                <!--edit-->
                ...
                <!--pritable view-->
                <a class="dropdown-item" href="<?php echo e(url('/invoices/'.$bill->bill_invoiceid.'/pdf?view=preview')); ?>" target="_blank"><i
                        class="ti-printer"></i><?php echo e(cleanLang(__('lang.printable_view'))); ?></a>
            </div>
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/bill/components/misc/invoice/actions.blade.php ENDPATH**/ ?>