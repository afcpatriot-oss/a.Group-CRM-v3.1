...
<div class="card-checklist checklist-comments-visible" id="card-checklist">
    ...
    <div class="x-content" id="card-checklists-container" data-progress-bar="hidden" data-type="form"
        ...
        data-url="<?php echo e(url('/tasks/update-checklist-positions')); ?>">
        <!--dynamic content here-->
        <?php if(config('response.import')): ?>
        <?php echo $__env->make('pages.task.components.checklist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>
    </div>
    ...
    <div class="x-action p-b-20">
        <a href="javascript:void(0)" class="js-card-checklist-toggle" id="card-checklist-add-new"
            data-action-url="<?php echo e(urlResource('/tasks/'.$task->task_id.'/add-checklist')); ?>"
        ...
        <?php echo $__env->yieldPushContent('actions_task_checklist'); ?>

    </div>

    <!--module extension point - allows modules to inject content-->
    <?php echo $__env->yieldPushContent('section_task_checklist'); ?>

    <!-- Import Checklist Container -->
    <div class="hidden" id="import-checklist-container" data-initial-url="<?php echo e(url('/fileupload')); ?>"
        data-url="<?php echo e(url('tasks/'.$task->task_id.'/import-checklists')); ?>" data-type="form"
    ...
    <?php endif; ?>
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/task/components/checklists.blade.php ENDPATH**/ ?>