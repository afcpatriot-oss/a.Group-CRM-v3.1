        ...
        <table class="table table-hover invoice-table <?php echo e(config('css.bill_mode')); ?>">
            <thead>
                <tr>
                    ...
                    <!--discount-->
                    <th
                        class="text-left x-discount bill_col_discount <?php echo e(runtimeVisibility('invoice-column-inline-discount', $bill->bill_tax_type)); ?>">
...
</div><?php /**PATH /home/u944590956/domains/agroupcrm.online/public_html/application/resources/views/pages/bill/components/elements/main-table.blade.php ENDPATH**/ ?>