    ...
    <div id="list-page-actions">
        ...
        <div class="header-search" id="header-search">
            ...
            <input type="text" class="form-control search-records list-actions-search"
                data-url="{{ urlResource('/orders/search') }}" data-type="form" data-ajax-type="post"
        ...
        <!--ARCHIVED ORDERS-->
        @if(config('visibility.archived_orders_toggle_button'))
        <button type="button" data-toggle="tooltip" title="{{ cleanLang(__('lang.show_archive_tickets')) }}"
            id="pref_filter_show_archived_orders"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark js-ajax-ux-request {{ runtimeActive(auth()->user()->pref_filter_show_archived_orders) }}"
            data-url="{{ urlResource('/orders/search?action=search&toggle=pref_filter_show_archived_orders') }}">
        ...
        <button type="button" data-toggle="tooltip" title="@lang('lang.export_ticket')"
            ...
            data-target="sidepanel-export-orders">
            <i class="ti-export"></i>
        </button>
        @endif
        ...
        <button type="button"
            ...
            data-toggle="modal" data-target="#commonModal" data-url="{{ urlResource('/orders/create') }}"
