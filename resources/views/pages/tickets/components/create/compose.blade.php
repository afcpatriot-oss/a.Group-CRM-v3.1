                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group" hidden aria-hidden="true">
                                <input
                                    ...
                                    name="ticket_subject"
                                    id="ticket_subject"
                                    value="{{ cleanLang(__('lang.order_created_by_system')) }}">
                            </div>

                            <!-- ticket message (system, hidden) -->
                            <div class="form-group" hidden aria-hidden="true">
                                <textarea
                                    class="tinymce-textarea"
                                    name="ticket_message"
                                    id="ticket_message"
                                    rows="15">{{ cleanLang(__('lang.order_processing')) }}</textarea>
                            </div>
                            ...
                            <div class="text-lg-right">
                                <button type="submit"
                                    ...
                                    id="ticket-compose-form-button"
                                    data-url="{{ url('/tickets') }}"
                                    data-type="form"
                                    data-ajax-type="post"
                                    data-loading-overlay-target="wrapper-tickets"
                                    data-loading-overlay-classname="overlay"
                                    data-form-id="ticket-compose">
                                    {{ cleanLang(__('lang.submit_ticket')) }}
                                </button>
                            </div>
