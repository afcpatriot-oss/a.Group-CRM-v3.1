...
class EditTagsResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event
        event(new \App\Events\Orders\Responses\OrderEditTags($request, $this->payload));
        ...
        if ($response == 'edit') {
            ...
            $html = view('pages/orders/components/modals/edit-tags', compact('tags', 'current_tags', 'order'))->render();
            $jsondata['dom_html'][] = [
        ...
        if ($response == 'update') {
            ...
            $html = view('pages/orders/components/table/ajax', compact('tags', 'orders'))->render();
            $jsondata['dom_html'][] = [
                'selector' => "#order_$id",
                'action' => 'replace-with',
                'value' => $html,
            ...
            if (request('action') == 'redirect') {
                $jsondata['redirect_url'] = url("orders/$id");
            }
