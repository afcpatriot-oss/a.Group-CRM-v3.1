...
class EditResponse implements Responsable {
    ...
    public function toResponse($request) {
        ...
        //fire event
        event(new \App\Events\Orders\Responses\OrderEdit($request, $this->payload));
        ...
        //render the form
        $html = view("pages/orders/components/modals/$template", compact('page', 'order', 'categories', 'projects', 'fields', 'statuses'))->render();
