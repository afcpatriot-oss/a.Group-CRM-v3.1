        ...
        try {
            ...
            foreach ($modules as $module) {
                ...
                if (file_exists($module_css)) {
                    ...
                    $css = '<link rel="stylesheet" href="/application/Modules/' . $module_name . '/Resources/assets/css/module.css">';
                } else {
                ...
                if (file_exists($module_custom_css)) {
                    ...
                    $custom_css = '<link rel="stylesheet" href="/application/Modules/' . $module_name . '/Resources/assets/css/custom.css">';
                } else {
                ...
                if (file_exists($module_js)) {
                    ...
                    $js = '<script src="/application/Modules/' . $module_name . '/Resources/assets/js/module.js"></script>';
                } else {
