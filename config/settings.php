...
// Добавляем настройки для заказов
     ...
     */
    'order_statuses' => [
        'new' => 'default',        // Новый заказ
        'processing' => 'info',    // В процессе
        'shipped' => 'success',    // Отправлен
        'delivered' => 'success',  // Доставлен
        'cancelled' => 'danger',   // Отменен
    ],

    /**
     * Various order priorities, with their corresponding bootstrap colors (colors are used for labels etc)
     * [IMPORTANT WARNING]
     * Only change the color values
     * [AVAILABLE VALUES]
     * default|info|warning|success|danger|primary|green|lime|brown
    ...
    'order_priority' => [
        'normal' => 'info',  // Обычный
        'high' => 'warning', // Высокий
        'urgent' => 'danger',// Срочный
    ],

    /**
     * Various ordering options for sorting orders.
     * [IMPORTANT WARNING]
     * Define the fields that can be used for sorting orders.
     */
    'ordering_options' => [
        'order_id',       // Сортировка по ID заказа
        'first_name',     // Сортировка по имени клиента
        'last_name',      // Сортировка по фамилии клиента
        'phone',          // Сортировка по номеру телефона
        'status_id',      // Сортировка по статусу заказа
